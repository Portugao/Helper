...
namespace MU\HelperModule\Menu\Base;
...
class AbstractItemActionsMenu implements ContainerAwareInterface
{
    ...
    public function menu(FactoryInterface $factory, array $options)
    {
        ...
        $entityDisplayHelper = $this->container->get('mu_helper_module.entity_display_helper');
        ...
        if ($entity instanceof ProductClassEntity) {
            $component = 'MUHelperModule:ProductClass:';
            $instance = $entity->getKey() . '::';
            $routePrefix = 'muhelpermodule_productclass_';
            ...
            if ($permissionApi->hasPermission($component, $instance, ACCESS_EDIT)) {
                ...
                $menu[$this->__('Edit')]->setLinkAttribute('title', $this->__('Edit this product class'));
                $menu->addChild($this->__('Reuse'), [
                    'route' => $routePrefix . $routeArea . 'edit',
                    'routeParameters' => ['astemplate' => $entity->getKey()]
                ])->setAttribute('icon', 'fa fa-files-o');
                $menu[$this->__('Reuse')]->setLinkAttribute('title', $this->__('Reuse for new product class'));
            }
            if ($permissionApi->hasPermission($component, $instance, ACCESS_DELETE)) {
                ...
                $menu[$this->__('Delete')]->setLinkAttribute('title', $this->__('Delete this product class'));
            }
            if ($context == 'display') {
