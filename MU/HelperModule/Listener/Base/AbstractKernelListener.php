...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from helper app';
     *     $event->getRequest()->attributes->set('MUHelperModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('MUHelperModule_test');`
     *     now `$testMessage` should be: `'Hello from helper app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('helper App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
