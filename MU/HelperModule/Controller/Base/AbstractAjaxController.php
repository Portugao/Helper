...
abstract class AbstractAjaxController extends AbstractController
{
    ...
    {
        if (!$this->hasPermission('MUHelperModule::Ajax', '::', ACCESS_EDIT)) {
            return true;
        }
        
        $objectType = $request->query->getAlnum('ot', 'productClass');
        ...
        $entityDisplayHelper = $this->get('mu_helper_module.entity_display_helper');
    ...
    protected function prepareSlimItem($repository, $objectType, $item, $itemId, $descriptionField)
    {
        ...
        $previewParameters = $this->get('mu_helper_module.controller_helper')->addTemplateParameters($objectType, $previewParameters, 'controllerAction', $contextArgs);
    
        $previewInfo = base64_encode($this->get('twig')->render('@MUHelperModule/External/' . ucfirst($objectType) . '/info.html.twig', $previewParameters));
    
        $title = $this->get('mu_helper_module.entity_display_helper')->getFormattedTitle($item);
