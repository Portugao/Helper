...
function mUHelperReadDate(val, includeTime)
{
...
function mUHelperValidateNoSpace(val)
{
    var valStr;
 ...
 */
function mUHelperExecuteCustomValidationConstraints(objectType, currentEntityId)
{
    jQuery('.validate-nospace').each( function() {
        if (!mUHelperValidateNoSpace(jQuery(this).val())) {
