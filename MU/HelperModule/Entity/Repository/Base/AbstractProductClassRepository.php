...
namespace MU\HelperModule\Entity\Repository\Base;
...
use MU\HelperModule\Helper\CollectionFilterHelper;

/**
 * Repository class used to implement own convenience methods for performing certain DQL queries.
 *
 * This is the base repository class for product class entities.
 */
abstract class AbstractProductClassRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'MU\HelperModule\Entity\ProductClassEntity';
     ...
     *
     * @return array|productClassEntity Retrieved data array or productClassEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved productClassEntity instances
     */
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if ((!$useJoins || !$slimMode) && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('productClass', $qb);
        }
    ...
    public function selectSearch($fragment = '', $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('productClass', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numProductClasses';
        if (true === $useJoins) {
    ...
    public function selectCount($where = '', $useJoins = false, $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('productClass', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of product classes to exclude (optional)
     *
     * @return boolean Result of this check, true if the given product class does not already exist
     */
