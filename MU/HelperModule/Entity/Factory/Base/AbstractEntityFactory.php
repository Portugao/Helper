...
namespace MU\HelperModule\Entity\Factory\Base;

use Doctrine\Common\Persistence\ObjectManager;
use Doctrine\ORM\EntityRepository;
use InvalidArgumentException;
use MU\HelperModule\Entity\Factory\EntityInitialiser;
...
abstract class AbstractEntityFactory
{
    ...
    {
        $entityClass = 'MU\\HelperModule\\Entity\\' . ucfirst($objectType) . 'Entity';
    ...
    /**
     * Creates a new productClass instance.
     *
     * @return MU\HelperModule\Entity\productClassEntity The newly created entity instance
     */
    public function createProductClass()
    {
        $entityClass = 'MU\\HelperModule\\Entity\\ProductClassEntity';

        $entity = new $entityClass();

        $this->entityInitialiser->initProductClass($entity);
    ...
    public function getIdField($objectType = '')
    {
        ...
        $entityClass = 'MUHelperModule:' . ucfirst($objectType) . 'Entity';
